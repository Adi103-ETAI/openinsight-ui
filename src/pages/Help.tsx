...
import { HelpCircle, Keyboard, BookOpen, MessageSquare, Sparkles, Search } from "lucide-react";
...
const Help = () => {
  ...
  return (
    <SettingsLayout
      title="Help & Support"
      description="Guides, shortcuts and direct support for clinical professionals."
